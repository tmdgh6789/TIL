...
player.prototype.create = function () {
    ...
    try {
        ...
        if (window.event != null) {
            btnPlay.attachEvent("onclick", function () {
                obj.play();
            });
            btnStop.attachEvent("onclick", function () {
                obj.stop();
            });
            btnPause.attachEvent("onclick", function () {
                obj.pause();
            });
            btnPrev.attachEvent("onclick", function () {
                obj.prev();
            });
            btnNext.attachEvent("onclick", function () {
                obj.next();
            });
            btnFoward.attachEvent("onclick", function () {
                obj.foward();
            });
            btnBackward.attachEvent("onclick", function () {
                obj.backward();
            });
            players.attachEvent("ontimeupdate", function () {
                obj.callback();
            });
            players.attachEvent("onended", function () {
                obj.next();
            });
        } else {
            ...
            players.addEventListener("timeupdate", function () {
                obj.callback();
            }, false);
